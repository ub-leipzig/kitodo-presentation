 ...
 * @constructor
 */
var dlfAudioPlayer = function dlfAudioPlayer(settings) {
    ...
    if (audioOptions === undefined) throw new Error('Missing audio configurations.');

    var format = dlfAudioPlayer.JPLAYER_MIMETYPE_FORMAT_MAPPING[audioOptions.mimeType] !== undefined ? dlfAudioPlayer.JPLAYER_MIMETYPE_FORMAT_MAPPING[audioOptions.mimeType] : 'mp3';
...
//# sourceMappingURL=tx_dlf_audioplayer.js.map
